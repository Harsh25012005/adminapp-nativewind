    ...
    <View className="px-4 mb-6">
      <View className="bg-purple-100 rounded-2xl p-4 border border-purple-200">
        <View className="flex-row items-center mb-3">
          <SparkleIcon />
          <Text className="text-sm font-semibold text-purple-900 ml-2">AI Suggestion</Text>
        </View>
        
        <Text className="text-sm text-purple-900 mb-4 leading-5">
          We suggest moving 3 SUVs from the suburb branch to downtown to increase utilization by 15% next month.
        </Text>

        <View className="flex-row gap-3">
          <TouchableOpacity className="bg-purple-700 px-4 py-2.5 rounded-lg flex-1">
            <Text className="text-white text-sm font-medium text-center">Update Vehicles</Text>
          </TouchableOpacity>
